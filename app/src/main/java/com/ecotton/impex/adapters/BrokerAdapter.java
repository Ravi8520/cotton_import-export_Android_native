...
import com.ecotton.impex.databinding.CustomeBrokerLayoutBinding;
import com.ecotton.impex.models.BrokerModel;

import java.util.ArrayList;
import java.util.List;

public class BrokerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {

    Context mcontext;
    public ArrayList<BrokerModel> mArrayList;
    private OnItemClickListener onItemClickListener;
    private final int VIEW_ITEM = 1;
    private final int VIEW_PROG = 0;
    private OnLoadMoreListener onLoadMoreListener;
    private boolean isMoreLoading = true;
    public ArrayList<BrokerModel> filterArray = new ArrayList<>();


    public BrokerAdapter(Context mcontext) {
    ...
    public void addAllClass(List<BrokerModel> models) {
        mArrayList.clear();
        filterArray.clear();
    ...
    public void addItemMore(List<BrokerModel> lst) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            ...
            CustomeBrokerLayoutBinding itemCardBinding = CustomeBrokerLayoutBinding.inflate(layoutInflater, parent, false);
    ...
    public void bindMyViewHolder(final DataViewHolder holder, final int position) {
        holder.binding.brokerName.setText(mArrayList.get(position).getName());
        holder.binding.brokerCity.setText(mArrayList.get(position).getDistrict_name());
        if (mArrayList.get(position).getType().equals("default")) {
            holder.binding.layoutMain.setBackgroundColor(mcontext.getResources().getColor(R.color.light_grey));
            holder.binding.layoutDelete.setVisibility(View.GONE);
        } else {
            holder.binding.layoutMain.setBackgroundColor(mcontext.getResources().getColor(R.color.white));
    ...
    class DataViewHolder extends RecyclerView.ViewHolder {
        public CustomeBrokerLayoutBinding binding;

        public DataViewHolder(CustomeBrokerLayoutBinding itemView) {
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<BrokerModel> filteredList = new ArrayList<>();

                    for (BrokerModel androidVersion : filterArray) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                mArrayList = (ArrayList<BrokerModel>) filterResults.values;
