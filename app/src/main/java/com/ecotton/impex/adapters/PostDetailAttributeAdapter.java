...
import com.ecotton.impex.databinding.MypostAttributeHorizontalItemBinding;
import com.ecotton.impex.models.PostDetailsModel;

import java.util.ArrayList;
import java.util.List;

public class PostDetailAttributeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {

    Context mcontext;
    public ArrayList<PostDetailsModel.Attribute> mArrayList;
    private OnItemClickListener onItemClickListener;
    private final int VIEW_ITEM = 1;
    private final int VIEW_PROG = 0;
    private OnLoadMoreListener onLoadMoreListener;
    private boolean isMoreLoading = true;
    public ArrayList<PostDetailsModel.Attribute> filterArray = new ArrayList<>();


    public PostDetailAttributeAdapter(Context mcontext) {
    ...
    public void addAllClass(List<PostDetailsModel.Attribute> models) {
        mArrayList.clear();
        filterArray.clear();
    ...
    public void addItemMore(List<PostDetailsModel.Attribute> lst) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            ...
            MypostAttributeHorizontalItemBinding itemCardBinding = MypostAttributeHorizontalItemBinding.inflate(layoutInflater, parent, false);
    ...
    public void bindMyViewHolder(final DataViewHolder holder, final int position) {
        ...
        holder.binding.txtAttribute.setText(mArrayList.get(position).getAttribute());
        holder.binding.txtFrom.setText(mArrayList.get(position).getAttribute_value());
        Log.e("mArrayList", "mArrayList==" + mArrayList.get(position).getAttribute_value());
    }
    ...
    class DataViewHolder extends RecyclerView.ViewHolder {
        public MypostAttributeHorizontalItemBinding binding;

        public DataViewHolder(MypostAttributeHorizontalItemBinding itemView) {
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<PostDetailsModel.Attribute> filteredList = new ArrayList<>();

                    for (PostDetailsModel.Attribute androidVersion : filterArray) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                mArrayList = (ArrayList<PostDetailsModel.Attribute>) filterResults.values;
