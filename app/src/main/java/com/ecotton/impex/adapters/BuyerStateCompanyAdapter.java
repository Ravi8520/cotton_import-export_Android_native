...
import com.ecotton.impex.databinding.LayoutStateItemBinding;
import com.ecotton.impex.models.dashboard.DashBoardModel;

import java.util.ArrayList;
import java.util.List;

public class BuyerStateCompanyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {

    Context mcontext;
    public ArrayList<DashBoardModel.CityModel> mArrayList;
    private OnItemClickListener onItemClickListener;
    private final int VIEW_ITEM = 1;
    private final int VIEW_PROG = 0;
    private OnLoadMoreListener onLoadMoreListener;
    private boolean isMoreLoading = true;
    public ArrayList<DashBoardModel.CityModel> filterArray = new ArrayList<>();


    public BuyerStateCompanyAdapter(Context mcontext) {
    ...
    public void addAllClass(List<DashBoardModel.CityModel> models) {
        mArrayList.clear();
        filterArray.clear();
    ...
    public void addItemMore(List<DashBoardModel.CityModel> lst) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            ...
            LayoutStateItemBinding itemCardBinding = LayoutStateItemBinding.inflate(layoutInflater, parent, false);
    ...
    public void bindMyViewHolder(final DataViewHolder holder, final int position) {
        ...
        DashBoardModel.CityModel obj = mArrayList.get(position);
    ...
    class DataViewHolder extends RecyclerView.ViewHolder {
        public LayoutStateItemBinding binding;

        public DataViewHolder(LayoutStateItemBinding itemView) {
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<DashBoardModel.CityModel> filteredList = new ArrayList<>();

                    for (DashBoardModel.CityModel androidVersion : filterArray) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                mArrayList = (ArrayList<DashBoardModel.CityModel>) filterResults.values;
